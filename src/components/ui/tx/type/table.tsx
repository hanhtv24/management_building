...
import { TTable, TxType } from '@/types';

type Props = {} & TTable<TxType>;

const columns = [
  { key: 'maLgd', label: 'Mã loại' },
  { key: 'tenLgd', label: 'Tên loại' },
  { key: 'moTa', label: 'Mô tả' },
];

const TableTxType: React.FC<Props> = ({
  isLoading,
  data,
  filter,
  setFilter,
